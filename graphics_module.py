...
grid_size = 14
#fonts
custom_font = pygame.font.Font("./Graphics/WELLSLEY.TTF", 20)  # Replace with your font file
custom_font2 = pygame.font.Font("./Graphics/WELLSLEY.TTF", 48)  # Replace with your font file
custom_font2_outer = pygame.font.Font("./Graphics/WELLSLEY.TTF", 51) 
terminal_font = pygame.font.Font("./Graphics/PR Viking.ttf", 14)
#infobars
sealO= pygame.image.load("./Graphics/level_seal.png")
seal= pygame.transform.scale(sealO, (85,85))
terminal_barO = pygame.image.load("./Graphics/terminal_box.png")
InfobarO = pygame.image.load("./Graphics/player_info_box.png")
#player
fpimage = pygame.image.load("./Graphics/character_forward.png")
bpimage = pygame.image.load("./Graphics/character_back.png")
rpimage = pygame.image.load("./Graphics/character_right.png")
lpimage = pygame.image.load("./Graphics/character_left.png")
player_graphic =[fpimage,bpimage,rpimage,lpimage]

#enemies
wolves_frontO = pygame.image.load("./Graphics/wolf_forward.png")
wolves_backO = pygame.image.load("./Graphics/wolf_back.png")
wolves_rightO = pygame.image.load("./Graphics/wolf_right.png")
wolves_leftO = pygame.image.load("./Graphics/wolf_left.png") 
wolves = [wolves_frontO,wolves_backO,wolves_rightO,wolves_leftO]
#obstacles
customsize3 = (50, 70)
tree1O = pygame.image.load("./Graphics/tree.png")
tree1 = pygame.transform.scale(tree1O,image_size)
tree2O = pygame.image.load("./Graphics/pine_tree.png")
tree2 = pygame.transform.scale(tree2O,customsize3)
customsize2 = (45,35)
customsize4 = (25,25)
#rock1O = pygame.image.load("./Graphics/moss_rock.png")
#rock1 = pygame.transform.scale(rock1O,customsize2)
rock2O = pygame.image.load("./Graphics/stone 2.png")
rock2 = pygame.transform.scale(rock2O,customsize2)
logO = pygame.image.load("./Graphics/log.png")
log = pygame.transform.scale(logO,customsize4)
stumpO = pygame.image.load("./Graphics/stump.png")
stump= pygame.transform.scale(stumpO,customsize2)
mapleO = pygame.image.load("./Graphics/maple.png")
...
customsize = (80,80)
grass_floor3O = pygame.image.load("./Graphics/Grass_1.png")
grass_floor3 = pygame.transform.scale(grass_floor3O,customsize)
grass_floor1O = pygame.image.load("./Graphics/Grass_2.png")
grass_floor1= pygame.transform.scale(grass_floor1O,customsize)
grass_floor2O = pygame.image.load("./Graphics/grass floor.png")
forest_backgroundO = pygame.image.load("./Graphics/Forest_Borders_PNG_Images___Forest__Trees__Rectangle_PNG_Transparent_Background_-_Pngtree-removebg-preview.png")
...
#abilities
sword = pygame.image.load("./Graphics/sword.png")
woosh = pygame.image.load("./Graphics/woosh.png")
healring = pygame.image.load("./Graphics/healing.png")
semetricheart = pygame.image.load("./Graphics/symetricheart.png")
growingheart = pygame.image.load("./Graphics/growingheart.png")
